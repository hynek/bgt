...
> [!WARNING]
> Before starting to work on **feature** pull requests, **please** discuss your idea with us on the [Ideas board](https://github.com/hynek/bgt/discussions/categories/ideas) to save you time and effort!
...
- Make sure your changes pass our [CI](https://github.com/hynek/bgt/actions).
...
- Refer to all symbols by their fully-qualified names.
  For example, `bgt.Foo` – not just `Foo`.
...
- Prefer simple past tense or constructions with "now".
  ...
  - `bgt.func()` that does foo.
    It's pretty cool.
    [#1](https://github.com/hynek/bgt/pull/1)


  ### Fixed

  - `bgt.func()` now doesn't crash the Large Hadron Collider anymore.
    That was a nasty bug!
    [#2](https://github.com/hynek/bgt/pull/2)
  ```
...
[llm]: https://github.com/hynek/bgt/blob/main/.github/AI_POLICY.md
